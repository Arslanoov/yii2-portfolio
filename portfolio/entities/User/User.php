...
namespace portfolio\entities\User;

use portfolio\entities\AggregateRoot;
use portfolio\entities\EventTrait;
...
class User extends ActiveRecord implements AggregateRoot
{
    ...
    public function editProfile(string $username, string $aboutMe): void
    {
        $this->username = $username;
        $this->about_me = $aboutMe;
        $this->updated_at = time();
